...
var isTemperatureAnalysis = false;
...
var dashboard = JSON.stringify(args.dashboard);
if(dashboard.includes("TemperatureAnalysis")){
  isTemperatureAnalysis = true;
}
...
if(isTemperatureAnalysis){
  graphGenerator.initAndStartTemperatureAnalysis(jsonData);
}else{
