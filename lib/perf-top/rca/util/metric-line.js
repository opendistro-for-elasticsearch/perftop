...
function generateAndUpdateLineData (metricLine) {
  var dataGenerator = metricLine.dataGenerator;
  dataGenerator.getMetricData(metricLine.endpoint, metricLine.name, metricLine.local, metricLine.dimension, metricLine.graphParams, "lines",
    function (metricData) { 
