 ...
 */
function metricDonutRCA (endpoint, gridOptions, queryParams, options, dimension, graphParams, screen) {
 ...
 */
metricDonutRCA.prototype.emit = function () {
 ...
 * @param {object} screen - blessed.screen() object.
 */
metricDonutRCA.prototype.generateGraph = function (donut, screen) {
...
function generateMetricDonutData (metricDonut, callback) {
  dataGenerator.getMetricDataRCA(metricDonut.endpoint, metricDonut.name, metricDonut.local, metricDonut.dimension, metricDonut.graphParams, "donuts", function (metricData) {
    dataGenerator.removeStaleDataRCA(metricData, metricDonut);
...
module.exports.metricDonutRCA = metricDonutRCA;
