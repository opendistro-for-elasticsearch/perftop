 ...
 */
function metricLineTemperatureRCA (endpoint, gridOptions, queryParams, options, dimension, graphParams, screen) {
 ...
 */
metricLineTemperatureRCA.prototype.emit = function () {
 ...
 * @param {object} screen - blessed.screen() object.
 */
metricLineTemperatureRCA.prototype.generateGraph = function (line, screen) { // /Called by metric-graph.start()
 ...
 */
function generateAndUpdateLineData (metricLine) { //called every five seconds
  dataGenerator.getMetricDataTemperatureAnalysis(metricLine.endpoint, metricLine.name, metricLine.local, metricLine.dimension, metricLine.graphParams, "lines",
    function (metricData) { 
      ...
      if (metricData.fields === null || metricData.fields.length === 0) {
        ...
        dimension: ${metricLine.dimension}\n
        graphParams:${metricLine.graphParams}\n`);
        return;
      }   
      dataGenerator.removeStaleDataTemperatureAnalysis(metricData, metricLine);
...
module.exports.metricLineTemperatureRCA = metricLineTemperatureRCA;
