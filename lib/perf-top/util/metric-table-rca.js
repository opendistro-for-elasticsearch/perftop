 ...
 */
function metricTableRCA (endpoint, gridOptions, queryParams, options, dimension, graphParams, screen) {
 ...
 */
metricTableRCA.prototype.emit = function () {
 ...
 * @param {object} screen - blessed.screen() object.
 */
metricTableRCA.prototype.generateGraph = function (table, screen) {
...
function generateMetricTableData (metricTable, callback) {
  dataGenerator.getMetricDataRCA(metricTable.endpoint, metricTable.name, metricTable.local, metricTable.dimension, metricTable.graphParams, "tables",
    function (metricData) {
      if (metricData.fields === null || metricData.fields.length === 0) {
        callback({});
      }
      dataGenerator.removeStaleDataRCA(metricData, metricTable);
...
module.exports.metricTableRCA = metricTableRCA;
