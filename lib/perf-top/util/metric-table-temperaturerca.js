 ...
 */
function metricTableTemperatureRCA (endpoint, gridOptions, queryParams, options, dimension, graphParams, screen) {
 ...
 */
metricTableTemperatureRCA.prototype.emit = function () {
 ...
 * @param {object} screen - blessed.screen() object.
 */
metricTableTemperatureRCA.prototype.generateGraph = function (table, screen) {
...
function generateMetricTableData (metricTable, callback) {
  dataGenerator.getMetricDataTemperatureAnalysis(metricTable.endpoint, metricTable.name, metricTable.local, metricTable.dimension, metricTable.graphParams, "tables",
    function (metricData) {
      if (metricData.fields === null || metricData.fields.length === 0) {
        callback({});
      }
      dataGenerator.removeStaleDataTemperatureAnalysis(metricData, metricTable);
...
module.exports.metricTableTemperatureRCA = metricTableTemperatureRCA;
